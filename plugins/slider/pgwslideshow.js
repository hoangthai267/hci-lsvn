...
;(function($){
    $.fn.pgwSlideshow = function(options) {
        ...
        var setup = function() {
            ...
            if (pgwSlideshow.slideCount > 1) {
                ...
                if (pgwSlideshow.config.displayControls) {
                    pgwSlideshow.plugin.find('.ps-current').append('<span class="ps-prev"><span class="fa fa-angle-left fa-3x"></span></span>');
                    pgwSlideshow.plugin.find('.ps-current').append('<span class="ps-next"><span class="fa fa-angle-right fa-3x"></span></span>');
        ...
        var finishElement = function(element) {
            ...
            var elementText = '';
            if (element.title) {
                elementText += '<a href="#">' + '<b>' + element.title + '</b>' + '</a>';
            }
